...
public class ListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("nowId : " + signid);
	    System.out.println("///");
		...
		if(followinglist != null) {
			...
			request.setAttribute("followinglist", null);
		...
		if(followerlist != null) {
			...
			request.setAttribute("followerlist", null);
		...
		if(followinglist != null) {
			...
			request.setAttribute("myfollowinglist", null);
